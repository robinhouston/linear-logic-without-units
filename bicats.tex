...
% the composite $g\o f$ just as $gf$, and
%  !! No we won't !! Fix any such uses !!
an identity arrow $1_A$ just as $1$ when its type is clear from the context.
% (Occasionally there may be a potential ambiguity between vertical composition --
% i.e.\ the composition of 2-cells within a hom-category -- and horizontal composition.
% In such situations we are careful to write horizontal composition as $\o$.)
