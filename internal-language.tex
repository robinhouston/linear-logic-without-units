...
\item $\semint[Bigg]{\begin{prooftree}
	...
	\newline\vskip1ex\strut\hfil$=
	v(t)\o\Bigl(
		\semint{\Gamma_{1}\proves\gamma_{1}\in\A_{1}}
		\tn\cdots\tn
		\semint{\Gamma_{n}\proves\gamma_{n}\in\A_{n}}
	\Bigr)$,
...
\begin{lemma}[Semantics of 1-in-2 substitution]\label{lemma-sem-1in2}
	Let
	\[
		\Gamma_{1} \proves \gamma_{1}\in\CB_{1}
		\quad\cdots\quad
	...
	\begin{mmulti}
		...
		\o
		\Bigl(
			\semint{\Gamma_{1}\proves \gamma_{1}\in\CB_{1}}
			\tn\cdots\tn
			\semint{\Gamma_{n}\proves \gamma_{n}\in\CB_{n}}
		\Bigr)
	\end{mmulti}
\end{lemma}
\begin{proof}
...
\begin{proof}
	...
	\begin{mmulti}
		...
		\\=
		\semint{\beta[A_{i} := \phi_{i}]_{i}}\cdot\semint{t_{\gamma_{1},\dots, \gamma_{n}}}
		\\=
		\bigl(
			(\semint{\phi_{1}}\tn\cdots\tn\semint{\phi_{n}})\o\semint{\beta}
		\bigr)
		\cdot
		\bigl(
			(\semint{\gamma_{1}}\tn\cdots\tn\semint{\gamma_{n}})
			\o v(t)
		\bigr)
		\\=
		(\semint{\phi_{1}}\tn\cdots\tn\semint{\phi_{n}})\o v(t)
		\\=
		\bigl(
			(\semint{\delta_{1}}\tn\cdots\tn\semint{\delta_{n}})
			\o v(t)
		\bigr)
		\cdot
		\bigl(
			(\semint{\phi_{1}}\tn\cdots\tn\semint{\phi_{n}})\o\semint{\alpha}
		\bigr)
		\\=
		\semint{t_{\delta_{1},\dots, \delta_{n}}}
		\cdot
		\semint{\alpha[A_{i}:=\phi_{i}]_{i}}
		\\=
