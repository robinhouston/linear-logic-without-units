...
right $\C$-modules.
\begin{definition} % Right \C-module
	...
	\]
\end{definition}
\begin{definition} % Map of modules
	...
	\]
\end{definition}
\begin{definition} % The bicategory Mod_\C
...
as the unit condition in the definition of pseudo-natural transformation is redundant, so (Proposition~\chref{Bicats}{prop-psnat-redundant})
